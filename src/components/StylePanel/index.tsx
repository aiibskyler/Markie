    ...
    <div className={styles.panel}>
      ...
      <div className={styles.content}>
        <Section title={L('style.fonts')}>
          ...
          <SelectInput label={L('style.headingFont')} value={headingFont || globalFont} options={[{ value: '', label: L('style.sameAsBody') }, ...builtinFonts.map(f => ({ value: f.family, label: f.name }))]} onChange={(v) => setHeadingFont(v || globalFont)} />
        ...
        <Section title={L('style.headings')}>
        ...
        <Section title={L('style.bodyText')}>
        ...
        <Section title={L('style.blockquote')}>
        ...
        <Section title={L('style.codeBlock')}>
